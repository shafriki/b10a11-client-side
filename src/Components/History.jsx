...
const History = () => {
    return (
        <div className='relative bg-fixed mx-3 md:mx-auto flex flex-col py-16 md:py-24 my-32 bg-cover bg-center' style={{ backgroundImage: "url('https://i.ibb.co.com/98mbN9g/pexels-runffwpu-2654902.jpg')" }}>
